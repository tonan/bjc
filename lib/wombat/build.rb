...
class BuildRunner
  ...
  def build_hash
    ...
    templates.each do |template_name|
      if template_name =~ /bjc-infranodes/
      ...
      elsif template_name == 'bjc-build-node'
        build_nodes.each do |name, num|
          proc_hash[name] = {
            'template' => 'bjc-build-node',
            'options' => {
              'node-number' => num
            }
          }
        end
      elsif template_name == 'bjc-workstation'
        workstations.each do |name, num|
          proc_hash[name] = {
            'template' => 'bjc-workstation',
            'options' => {
